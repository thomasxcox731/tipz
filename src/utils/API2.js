...
// startStreet = this.state.startStreet.split(" ").join("+");
// startCity = this.state.startCity.split(" ").join("+");
// startState = this.state.startState.split(" ").join("+");
...
export default {
    ...
    getCoords: function (dropdownVal) {
        ...
        // var ip = "https://maps.googleapis.com/maps/api/geocode/json?address=,+tx&sensor=false&key=AIzaSyCHZqKS_YadIq4eOAtVad2cxcHixlT6poI"
        var ip = "https://maps.googleapis.com/maps/api/geocode/json?address=" + this.props.startStreet + ",+" + this.props.startCity + ",+" + this.props.startState + "&sensor=false&key=" + apiKey;
